...
parser.add_argument('--model_name', type=str, default='RIPGeoContrast-调试程序')
...
parser.add_argument('--loss_contrast_ratio', type=float, default=0.2)
parser.add_argument('--loss_mse_ratio', type=float, default=0.8)

parser.add_argument('--lr', type=float, default=1e-4)
parser.add_argument('--harved_epoch', type=int, default=8)
...
if __name__ == '__main__':
	...
	for epoch in range(2000):
		...
		for i in range(len(train_data)):
			...
			# if train_data[i]["router"] == '205.251.126.93':
			# 	continue
			# 丢掉包含ip数量少的batch
